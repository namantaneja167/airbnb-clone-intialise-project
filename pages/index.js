...
export async function getStaticProps(){
  ...
  const exploreData = await fetch("https://jsonkeeper.com/b/8JWF").then((res)=>res.json());
  // const cardsData = await fetch("https://links.papareact/zp1").then((res)=>res.json());
  const cardsData = await fetch("https://jsonkeeper.com/b/MTN1").then((res)=>res.json());
